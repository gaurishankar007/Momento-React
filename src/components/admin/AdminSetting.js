...
const AdminSetting =()=> {
    ...
    const editUsername = (event)=> {
        ...
        const apiResponse = axios.put(`${REACT_APP_BASE_URL}admin/changeUsername`, {username}, config)
    ...
    const editEmail = (event)=> {
        ...
        const apiResponse = axios.put(`${REACT_APP_BASE_URL}admin/changeEmail`, {email}, config)
        apiResponse.then((result)=> {
    ...
    const editPhone = (event)=> {
        ...
        const apiResponse = axios.put(`${REACT_APP_BASE_URL}admin/changePhone`, {phone}, config)
        apiResponse.then((result)=> {
